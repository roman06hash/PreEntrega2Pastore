...
function conf_compra(trago, contains) {
    let confirmacion = confirm("Realmente deseas comprar " + trago + "?, esta bebida " + contains + " alcohol.")
    return confirmacion;
}
...
while (usar_programa) {
    ...
    while (isNaN(edad_cliente)) {
        edad_cliente = retry("introduzca su edad", edad_cliente)
    }
